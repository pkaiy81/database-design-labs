 ...
 * <li>An edge from Tx A to Tx B means "A is waiting for B to release a
 * lock"</li>
...
public class WaitForGraph {
     ...
     * 
     * <p>
     * This indicates that {@code waiter} is now waiting for {@code holder} to
     * release a lock.
     * 
     ...
     * 
     * <p>
     * This should be called when {@code waiter} stops waiting for {@code holder}
     ...
     * 
     * <p>
     * This should be called when a transaction commits, rolls back, or is aborted.
     * 
     ...
     * 
     * <p>
     * This method performs a depth-first search (DFS) from each node to detect
     * cycles.
     * A cycle indicates a deadlock.
     * 
     * @return a list of transaction IDs involved in the deadlock cycle, or empty if
     *         no cycle exists
     */
     ...
     * @param recStack set of nodes in the current recursion stack (for cycle
     *                 detection)
     ...
     * @return a set of transaction IDs that the given transaction is waiting for,
     *         or empty set
     */
