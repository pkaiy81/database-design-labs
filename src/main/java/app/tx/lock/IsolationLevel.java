 ...
 * 
 * <p>Each isolation level provides different guarantees about concurrent transaction behavior:
 * 
 * <h3>READ_UNCOMMITTED</h3>
 * <ul>
 *   <li><b>Dirty Read:</b> ❌ Allowed - can read uncommitted data from other transactions</li>
 *   <li><b>Non-repeatable Read:</b> ❌ Allowed - same query may return different results</li>
 *   <li><b>Phantom Read:</b> ❌ Allowed - new rows may appear in range queries</li>
 ...
 *   <li><b>Non-repeatable Read:</b> ✅ Prevented - same query returns same results</li>
 *   <li><b>Phantom Read:</b> ❌ Allowed</li>
...
public enum IsolationLevel {
     ...
     * 
     * <p>If false, read locks are released immediately after the read (READ_COMMITTED behavior).
     * If true, read locks are held until commit/rollback (REPEATABLE_READ and SERIALIZABLE).
     * 
     ...
     * 
     * <p>This is true only for SERIALIZABLE, which prevents phantom reads.
     * 
