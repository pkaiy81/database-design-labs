 ...
 * <li>Different isolation levels (READ_UNCOMMITTED, READ_COMMITTED,
 * REPEATABLE_READ, SERIALIZABLE)</li>
 * </ol>
 */
public class DeadlockAndIsolationDemo {
    ...
    private static void demonstrateNonRepeatableRead(IsolationLevel level, BlockId testBlock)
